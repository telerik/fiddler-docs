...
meta_title: Configure WinHTTP Application - Fiddler Classic Documentation
description: Learn how to configure a WinHTTP application to route its traffic through the Fiddler Classic web debugging proxy.
