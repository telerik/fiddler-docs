...
page_title: Authenticating to CBT-Protected Server - Fiddler Classic
description: Configure Fiddler Classic to authenticate to a server protected with Channel Binding Tokens.
