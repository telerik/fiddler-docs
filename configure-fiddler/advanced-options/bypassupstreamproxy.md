...
page_title: Bypassing the Upstream Proxy - Fiddler Classic
description: Configure Fiddler Classic to bypass the upstream proxy for all requests to a specific domain.
