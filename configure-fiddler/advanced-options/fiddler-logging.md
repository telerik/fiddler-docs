...
page_title: Logging in Fiddler Classic Application - Fiddler Classic
description: Configure Fiddler Classic to log specific data by using the built-in FiddlerScript logging mechanism.
