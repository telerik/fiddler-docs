...
meta_title: Repeat 401 Errors - Fiddler Classic Documentation
description: Learn how to resolve repeated 401 authentication errors and Windows security prompts when connecting to a server protected with channel-binding tokens.
