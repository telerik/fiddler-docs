...
page_title: Running Fiddler as Administrator - Fiddler Classic
description: Troubleshoot missing traffic capture when the ProxySettingsPerUser Group Policy is set to zero.
