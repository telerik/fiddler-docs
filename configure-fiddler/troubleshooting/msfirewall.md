...
Microsoft Firewall client for Microsoft ISA 2004 has an option to automatically reconfigure Internet Explorer settings. Unfortunately, this setting causes Internet Explorer to detach from Fiddler Classic at random times. 
...
* If there is no Firewall Client icon in your system tray:
	...
	3. Click the ![Firewall Client Management icon](./images/FirewallClient.png).
