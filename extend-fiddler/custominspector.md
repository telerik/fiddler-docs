...
page_title: Building a Custom Inspector - Fiddler Classic
description: Build a custom inspector for Fiddler Classic by deriving from the Inspector2 class and implementing an inspector interface.
