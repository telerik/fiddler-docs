...
page_title: Reducing Delays from Expect Headers - Fiddler Classic
description: Configure Fiddler Classic to handle Expect 100-continue headers and reduce request delays.
