...
1. Install the [Privacy Scanner Fiddler Classic add-on](https://www.telerik.com/fiddler/add-ons). Fiddler Classic gains a new top-level menu named **Privacy**.
    ![Privacy menu](./images/PrivacyMenu.png)
2. Ensure **Privacy** > **Enabled** is checked. The add-on adds a **Privacy Info** column to the session list and flags HTTP/HTTPS responses which set cookies. Evaluation of any P3P statements that come along with those cookies changes the session's background color:
