...
page_title: Creating Session Alerts - Fiddler Classic
description: Create alerts for specific sessions in Fiddler Classic by adding custom FiddlerScript rules.
slug: SessionAlerts
publish: true
position: 6
res_type: kb
