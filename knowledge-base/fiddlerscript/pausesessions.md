...
page_title: Pausing Web Sessions - Fiddler Classic
description: Pause specific web sessions in Fiddler Classic by adding FiddlerScript rules to the OnBeforeRequest function.
slug: PauseSessions
publish: true
position: 5
res_type: kb
...
To pause specific sessions, [add rules](slug://AddRules) using FiddlerScript to the `OnBeforeRequest` function (except where noted). For example:
