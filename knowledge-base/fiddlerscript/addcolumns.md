...
page_title: Adding Custom Columns via FiddlerScript - Fiddler Classic
description: Add custom columns to the Fiddler Classic Web Sessions List by using FiddlerScript rules.
slug: AddColumns
publish: true
res_type: kb
position: 7
