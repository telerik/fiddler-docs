...
Date the response expires and is no longer used by a cache.  See [http://www.mnot.net/cache_docs/][6] or pg 183.  Note that the `Cache-Control` header overrules this header in a HTTP/1.1 client.
