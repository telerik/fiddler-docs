...
page_title: Running ExecAction Commands - Fiddler Classic
description: Automate Fiddler Classic tasks like clearing traffic and saving sessions by using ExecAction commands.
slug: ExecAction
publish: true
position: 10
res_type: kb
