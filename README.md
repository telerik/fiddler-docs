...
<p>It also means that you can play a role in making our docs better for everyone, and if helping us make the Fiddler Classic docs better sounds interesting to you, read on.</p>

<h2>
<a name="contributing" class="anchor" href="#contributing"><span class="mini-icon mini-icon-link"></span></a>Contributing</h2>

<p>There are two ways you can contribute to the public Fiddler Classic documentation: either create an issue in this repository, or fork the repo, make the change and send us a pull request!</p>
...
<p>Once you've read these--or you've already memorized them--you're ready to contribute to the Fiddler Classic docs. Start by creating a local clone of our repo either using <a href="http://windows.github.com/">GitHub for Windows</a>, <a href="http://mac.github.com/">GitHub for Mac</a> or your friendly command-line:</p>
...
<p>Once you've made your changes, commit, pull, merge, push, and <a href="https://help.github.com/articles/using-pull-requests">send us a pull request</a>! We--and Fiddler Classic users everywhere--thank you for making our docs better! </p>
</li>
</ul></article>
